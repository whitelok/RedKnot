...
def _ih_reproducibility_manifest(
    ...
    optional_source_paths = {
        "http_entry": REPO
        / "test/srt/redknot/benchmark_dsv4_pro0813_redknot_http.py",
        "qualification_profile_verifier": REPO
        / "test/srt/redknot/verify_pro0813_qualification_profile.py",
        "one_target_wrapper": REPO
        / "test/srt/redknot/run_deepseek_v4_pro0813_reproduction.sh",
        "combined_supervisor": REPO
        / "test/srt/redknot/run_pro0813_combined_supervisor.sh",
        "all_target_sequencer": REPO
        / "test/srt/redknot/run_deepseek_v4_pro0813_all_targets.sh",
    }
    source_files = {
        name: {
            "path": str(path),
