...
holder_cwd=${REDKNOT_HOLDER_CWD:-/workspace/RedKnot/test/srt/redknot}
...
"$runtime_python" "$repo/test/srt/redknot/benchmark_dsv4_pro0813_redknot_http.py" \
  --contract-only \
...
setsid env \
  ...
  "$runtime_python" test/srt/redknot/benchmark_dsv4_pro0813_redknot_http.py \
    --mode redknot \
    --port "$server_port" \
